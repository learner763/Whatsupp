...
function Home()
{
    ...
    return(
        ...
        <div className='home' style={{display:loaded==true? 'flex':'none'}}>
            ...
            <div className='msg_div' style={{display:disp,background:reply_to.length>0 || msg_before_edit.length>0?'green':'white',left:innerwidth>1100 && document.getElementsByClassName('main_body_section')[0]?(parseInt(getComputedStyle(document.getElementsByClassName('main_body_section')[0]).width)/2)-49+'px':'auto'}}>
