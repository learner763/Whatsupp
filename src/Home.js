                        ...
                        {messages.map((value,index)=>
                            {
                                return(
                                    <div onClick={(e)=>{
                                        ...
                                        <img style={{flexShrink: '0',borderRadius:'50%',width:'50px',height:'50px',objectFit:'cover',marginLeft:'5px',border:bgr!=='black'?up_user===value[0]?profile_pic==='dp.png'?'1px gray solid':'none':profile_images[indices.indexOf(value[0])]==='dp.png'?'1px gray solid':'none':'none'}} src={value[0]===up_user?profile_pic: profile_images[indices.indexOf(value[0])]}></img>
                                        <div style={{display:'flex',flexDirection:'column',height:'60px',minWidth:'0'}}>    
                                            <div style={{height:'30px',fontWeight:'bold',alignItems:'center'}}>
                                                ...
                                                <span style={{color:bgr==='black'?'lime':'#555',paddingRight:'5px',fontSize:'12px',marginLeft:'auto',overflow:'visible',whiteSpace:'nowrap'}}>
                                            ...
                                            <div style={{height:'30px',alignItems:'center'}}>
                                                <span style={{fontWeight:'normal',paddingLeft:'5px',color:status[indices.indexOf(value[0])]==="(Typing...)"?bgr==='black'?'lime':'darkgreen':bgr==='black'?'white':'#555',fontSize:'17px'}}><span style={{color:`${value[1][value[1].length-1].startsWith('✔✔✔✔')?'deepskyblue':'darksalmon'}`}}>{status[indices.indexOf(value[0])]==="(Typing...)"?"":value[1][value[1].length-1].startsWith('✔✔')?'✔✔':value[1][value[1].length-1].startsWith('✔')?"✔":''}</span>{status[indices.indexOf(value[0])]==="(Typing...)"?"Typing...": value[1][value[1].length-1].slice(value[1][value[1].length-1].indexOf(' '),value[1][value[1].length-1].lastIndexOf(' '))}</span>
