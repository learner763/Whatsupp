        ...
        <div className='home' style={{display:loaded==true? 'flex':'none'}}>
            ...
            <div className='body_section' style={{backgroundColor:bgr}} >
                ...
                <div className='main_body_section'>
                    <label  id="profile_name" style={{display:disp,background:bgr,width:innerwidth>1100 && document.getElementsByClassName('main_body_section')[0]?parseInt(getComputedStyle(document.getElementsByClassName('main_body_section')[0]).width)+'px':'100%'}}>
                            ...
                            if(receiver==messages[index][0])
                            {
                                return(
                                    <div key={index} className='chat_detail' style={{display:'flex',flexDirection:'column'}} >
                                        ...
                                        (
                                            text.startsWith('✔')?
                                            (<span style={{gap:'3px',whiteSpace:'pre-line',marginRight:'10px',display:'flex',flexDirection:'column', overflowWrap:'break-word',marginTop:'10px', alignSelf:'flex-end',backgroundColor:'green',color:'white',borderRadius:'10px',maxWidth:'370px',padding:'5px 10px',fontSize:'18px'}}>
                                            ...
                                            text.startsWith(' ')?
                                            (<span style={{whiteSpace:'pre-line',marginLeft:'10px',display:'flex',flexDirection:'column', overflowWrap:'break-word',marginTop:'10px', alignSelf:'flex-start',backgroundColor:bgr==='black'?'darkorchid':'rebeccapurple',color:'white',borderRadius:'10px',maxWidth:'370px',padding:'5px 10px',fontSize:'18px',gap:'3px'}}>
                                    ...
                                    <div onClick={(e)=>{
                                        ...
                                        <div style={{marginRight:'10px',display:'flex',flexDirection:'column',height:'60px',minWidth:'0'}}>    
                                            <div style={{height:'30px',fontWeight:'bold',alignItems:'center'}}>
                                                ...
                                                <span style={{color:bgr==='black'?'#aaa':'#555',fontSize:'12px',marginLeft:'auto',overflow:'visible',whiteSpace:'nowrap',fontWeight:'normal '}}>
                                            ...
                                            <div style={{height:'30px',alignItems:'center'}}>
                                                ...
                                                (<>
                                                    <svg width="15" height="15" viewBox="0 0 16 15" fill="none" style={{minHeight:'15px',minWidth:'15px',marginTop:'1px'}}>
                                                    <path
                                                        d="M1.5 8L5.5 12L14.5 2"
                                                    ...
                                                    <svg width="15" height="15" viewBox="0 0 16 15" fill="none" style={{marginRight:'5px',minHeight:'15px',minWidth:'15px',marginTop:'1px'}}>
                                                    <path
                                                        d="M1.5 8L5.5 12L14.5 2"
                                                        stroke={value[1][value[1].length-1].startsWith('✔✔✔✔')?'deepskyblue':'darksalmon'}
                                                        strokeWidth="2"
            ...
            <div className='msg_div' style={{display:disp,background:reply_to.length>0 || msg_before_edit.length>0?'green':'white',left:innerwidth>1100 && document.getElementsByClassName('main_body_section')[0]?(parseInt(getComputedStyle(document.getElementsByClassName('main_body_section')[0]).width)/2)-221+270+'px':'auto'}}>
