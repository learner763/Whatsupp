                        ...
                        {messages.map((value,index)=>
                            {
                                return(
                                    <div onClick={(e)=>{
                                        ...
                                        <img style={{flexShrink: '0',borderRadius:'50%',width:'55px',height:'55px',objectFit:'cover',marginLeft:'5px',border:bgr!=='black' && up_user===value[0]?profile_pic==='dp.png':profile_images[indices.indexOf(value[0])]==='dp.png'?'1px darkgreen solid':'none'}} src={value[0]===up_user?profile_pic: profile_images[indices.indexOf(value[0])]}></img>
