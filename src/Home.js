        ...
        <div className='home' style={{display:loaded==true? 'flex':'none'}}>
            ...
            <div className='body_section' style={{backgroundColor:bgr}} >
                <div className='desktop_icons'>
                    ...
                    <label onClick={()=>set_menu('profile')} style={{width:'18px',textAlign:'center',color:menu==='profile'?bgr==='black'?'white':'#000000cc':'gray'}}><i style={{background:menu==='profile'?'linear-gradient(180deg,green 70%,darkgreen)':'gray',color:'white',borderRadius:'50%',padding:'10px'}}  class='fas fa-user'></i> Update Profile</label>
