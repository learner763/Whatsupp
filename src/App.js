      ...
      <div className="App" style={{display:ready===true?'flex':'none'}}>
        <div className='main_div' >
          ...
          margin: '0px 10px 10px 10px'}}>
            ...
            />
            <i style={{minWidth:'20px',maxWidth:'20px',color:'#000000cc',marginLeft:'auto'}} className={password_icon_content} 
            onClick={()=>
            {
          ...
          <hr style={{display:f, width: 'auto',  borderTop: "1px solid gray", margin: "10px" }} />        
          <button id='forgot_pass_button' onClick={() =>{ setvisibility("hidden") ; df("block");}}style={{visibility:visibility,margin:visibility==='visible'?'10px':'0px'}}>Forgot Password?</button>
